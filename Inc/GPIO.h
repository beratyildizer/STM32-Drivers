...
#define GPIO_AF10				(0x10U)
#define GPIO_AF11				(0x11U)
#define GPIO_AF12				(0x12U)
#define GPIO_AF13				(0x13U)
#define GPIO_AF14				(0x14U)
#define GPIO_AF15				(0x15U)
...
typedef struct
{
	...
	uint32_t Mode;						// @def_group GPIO_Modes
