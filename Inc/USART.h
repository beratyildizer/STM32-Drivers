...
typedef struct
{
	...
	uint32_t OverSampling;				// OverSampling Bits Modes @def_group OverSampling_Modes
	uint32_t HardwareFlowControl;		// HardwareFlowControl Bits Modes @def_group HardwareFlowControl_Modes
...
void USART_PeriphCmd(USART_HandleTypedef_t *USART_Handle, FunctionalState_t stataOfUSART);
